...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Issues.Domain.GroupsOfIssues.GroupOfIssues", b =>
                {
                    ...
                    b.Property<string>("_connectedStatusFlowId")
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("ConnectedStatusFlowId");

                    b.Property<string>("_typeOfGroupId")
                        .IsRequired()
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("TypeOfGroupId");

                    b.HasKey("Id");

                    b.HasIndex("_connectedStatusFlowId")
                        .IsUnique()
                        .HasFilter("[ConnectedStatusFlowId] IS NOT NULL");
            ...
            modelBuilder.Entity("Issues.Domain.Issues.Issue", b =>
                {
                    ...
                    b.Property<string>("_groupOfIssueId")
                        ...
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("GroupOfIssueId");

                    b.Property<string>("_statusInFlowId")
                        .IsRequired()
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("StatusInFlowId");
            ...
            modelBuilder.Entity("Issues.Domain.StatusesFlow.StatusInFlowConnection", b =>
                {
                    ...
                    b.Property<string>("_connectedStatusInFlowId")
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("ConnectedStatusInFlowId");

                    b.Property<string>("_parentStatusInFlowId")
                        .IsRequired()
                        .HasMaxLength(63)
                        .HasColumnType("nvarchar(63)")
                        .HasColumnName("ParentStatusInFlowId");
            ...
            modelBuilder.Entity("Issues.Domain.GroupsOfIssues.GroupOfIssues", b =>
                {
                    b.HasOne("Issues.Domain.StatusesFlow.StatusFlow", "ConnectedStatusFlow")
                        .WithOne("ConnectedGroupOfIssues")
                        .HasForeignKey("Issues.Domain.GroupsOfIssues.GroupOfIssues", "_connectedStatusFlowId");
